  ...
  return (
    <div className="flex flex-col w-96 space-y-2">
      ...
      <div className="flex flex-col text-sm text-gray-600 space-y-1">
        ...
        <p>
          <strong>수집 및 이용 목적:</strong> 회원 가입 의사 확인, 회원제 서비스
          제공에 따른 본인 식별 및 인증, 고지사항 전달, 고객 문의 처리 및 불만
          처리, 서비스 이용 관련 통계, 서비스 개선 및 개발을 위한 연구
        </p>
        <p>
        ...
        <p>
          ...
          개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다. 단, 동의를
          거부할 경우 회원가입이 제한될 수 있습니다.
        </p>
      </div>
    </div>
  );
